BEGIN;
TRUNCATE TABLE "quotation_has_product", "product", "range", "quotation", "delivery", "user", "profile" RESTART IDENTITY;
...
INSERT INTO "user" ("email", "company", "firstname", "lastname", "phone_number", "password", "invoice_address", "role", "profile_id")
VALUES
  ...
  ('test1@test.fr', "Boulangerie de la gare" 'Frederic', 'Babin', '0160142584', '$2b$10$NW8QoaLybPfVjJ5Q5zDJ/ucqL8WZEiMQZoVvl8OSXU5OHF3CxWEqK', '35 rue de la gare 85000 La roche sur yon', '1');
  

INSERT INTO "delivery" ("delivery_address", "user_id")
VALUES
  ('Boulangerie Mon client, 10 rue du client, 75012 Paris', 1);

INSERT INTO "quotation" ("user_id")
VALUES
  (1);
