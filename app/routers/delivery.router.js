 ...
 * @param {string} body.delivery_address.required - adresse de livraison
 ...
 */
  .post(validate(deliverySchema, 'body'), controllerWrapper(deliveryController.addDelivery));
 ...
 * PATCH /delivery/{id}
 * @tags Delivery
 * @summary Met à jour une adresse de livraison
 * @param {string} body.delivery_address.required - adresse de livraison
 * @param {number} query.id.required - id de l'adresse de livraison
 * @return {delivery} 200 - L'adresse de livraison a été mise à jour
 * @return {object} 403 - L'utilisateur n'a pas les droits pour modifier cette adresse de livraison
 */
  .patch(validate(deliverySchema, 'body'), controllerWrapper(deliveryController.patchDelivery))
 ...
 */
  .delete(controllerWrapper(deliveryController.deleteDelivery));
