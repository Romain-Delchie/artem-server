...
productRouter.route('/te/')
  /**
    * GET /product/te
    * @tags Product of range 'toile enfourneur'
    * @typedef {object} product
    * @summary Renvoi tous les produits de toile enfourneur
    * @return {[product]} 200 - products Un tableau de produits
    */
  .get(authMiddleware.checkToken, controllerWrapper(productController.getTE))

productRouter.route('/lam/')
  /**
    * GET /product/lam
    * @tags Product of range 'tapis de laminoir'
    * @typedef {object} product
    * @summary Renvoi tous les produits de tapis de laminoir
    * @return {[product]} 200 - products Un tableau de produits
    */
  .get(authMiddleware.checkToken, controllerWrapper(productController.getLam))
